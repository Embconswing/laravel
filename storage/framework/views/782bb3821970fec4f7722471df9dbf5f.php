        ...
        <div class="d-flex align-items-center mb-4 position-relative">
            ...
            <div class="d-flex gap-2" style="width:160px; justify-content:end;">
                ...
                <?php if(auth()->user()->isSupervisor()): ?>
                    <a href="<?php echo e(route('appointments.supervisorCases')); ?>" class="btn btn-sm btn-outline-danger"
                        title="Pending & Cancelled Applications">
                        🚨
                    </a>

                    <a href="<?php echo e(url('/admin/overview/application-pools')); ?>" class="btn btn-sm btn-outline-secondary"
                ...
                <a href="<?php echo e(route('appointments.bulk-ready-mail')); ?>" class="btn btn-sm btn-outline-danger"
                    title="Ready to Mail">
                    📦
                </a>

                <a href="<?php echo e(route('appointments.collect-documents')); ?>" class="btn btn-sm btn-outline-success"
                ...
                <a href="<?php echo e(route('applications.byStatus')); ?>" class="btn btn-sm btn-outline-primary"
                    title="Applications by Status">📋</a>
                <a href="<?php echo e(route('appointments.delete')); ?>" class="btn btn-sm btn-outline-danger"
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <h6 class="fw-bold mb-3">
                                Application Summary (<?php echo e($total); ?> Total)
                            </h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(auth()->user()->isNormal()): ?>
                                            ...
                                            <button type="button" onclick="openUnderProcessModal(<?php echo e($appointment->id); ?>)"
                                    ...
                                    <td>
                                        ...
                                        <?php echo $__env->renderWhen(view()->exists('dashboard.partials.return-actions'),
    ...
    <div id="underProcessModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <form method="POST" id="underProcessForm">
                ...
                <input type="hidden" name="status" value="<?php echo e(\App\Models\Appointment::STATUS_PROCESS_IN_PROGRESS); ?>">
    ...
    <div id="processCompletedModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <form method="POST" id="processCompletedForm">
                ...
                <input type="hidden" name="status" value="<?php echo e(\App\Models\Appointment::STATUS_PROCESS_COMPLETED); ?>">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            <?php if(session('reprint_id')): ?>
                ...
                if (confirm("Reference number updated successfully.\n\nDo you want to reprint the label?")) {
                    window.open("<?php echo e(route('appointments.printLabel', ':id')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Berlin-Appointments-30\resources\views/dashboard/my-assignments.blade.php ENDPATH**/ ?>