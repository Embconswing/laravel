                ...
                <form method="POST" action="<?php echo e(route('appointments.updateService', $appointment->id)); ?>">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($appointment->ReferenceNr); ?>" disabled>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Berlin-Appointments-25\resources\views/appointments/edit-service.blade.php ENDPATH**/ ?>