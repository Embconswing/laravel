                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-6" id="reference-wrapper">
                        ...
                        <input type="text" name="ReferenceNr" id="reference" class="form-control"
                            value="<?php echo e(old('ReferenceNr')); ?>" placeholder="Enter reference number">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Berlin-Appointments-20\resources\views/walk-ins/index.blade.php ENDPATH**/ ?>